...
use pubsub_core::{BrokerConfig, PubSubError};
...
impl TcpTransportListener {
    ...
    pub fn local_addr(&self) -> Result<std::net::SocketAddr, PubSubError> {
        self.tcp_listener.local_addr().map_err(PubSubError::from)
    }
}
