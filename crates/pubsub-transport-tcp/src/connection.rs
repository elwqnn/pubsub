...
use pubsub_protocol::PubSubCodec;

/// A framed TCP connection that reads/writes `Frame` values.
pub struct Connection {
    framed: Framed<TcpStream, PubSubCodec>,
...
impl Connection {
    pub fn new(stream: TcpStream, max_frame_size: usize) -> Self {
        ...
        let codec = PubSubCodec::new(max_frame_size);
        Self {
    ...
    pub fn into_framed(self) -> Framed<TcpStream, PubSubCodec> {
        self.framed
    }
}
